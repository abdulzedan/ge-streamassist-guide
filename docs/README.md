...
Suggested reading order for newcomers: **02 → 03 → 09** (auth, request shape,
stream parsing), then the capability chapters you need. Read **12** in full
...
5. [Invoking agents](05-invoking-agents.md)
6. [Tools](06-tools.md)
7. [Deep Research](07-deep-research.md)
8. [Files](08-files.md)
9. [Parsing the stream](09-parsing-the-stream.md)
10. [Agent management](10-agent-management.md)
11. [A2A](11-a2a.md)
