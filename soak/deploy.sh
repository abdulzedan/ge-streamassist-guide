...
LOCATION="${LOCATION:-global}"; ASSISTANT_ID="${ASSISTANT_ID:-default_assistant}"; API_VERSION="${API_VERSION:-v1}"
...
A2A_AGENT_ID="${SOAK_A2A_AGENT_ID:?set SOAK_A2A_AGENT_ID in .env}"
DATA_STORE_ID="${SOAK_DATA_STORE_ID:?set SOAK_DATA_STORE_ID in .env}"
LICENSE_LIMIT="${SOAK_LICENSE_LIMIT:-0}"
LICENSE_COUNT="${SOAK_LICENSE_COUNT:-0}"
LICENSE_EDITION="${SOAK_LICENSE_EDITION:-unconfigured}"
...
ENV_VARS+=",SOAK_A2A_AGENT_ID=${A2A_AGENT_ID},SOAK_DATA_STORE_ID=${DATA_STORE_ID}"
